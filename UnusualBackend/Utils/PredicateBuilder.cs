...
{
    public static Expression<Func<TradeStatsDto, bool>> Build(Filter filter)
    {
        var param = Expression.Parameter(typeof(TradeStatsDto), "x");
        var propName = TransformName(filter.Name);
        ...
        return Expression.Lambda<Func<TradeStatsDto, bool>>(body, param);
    }
